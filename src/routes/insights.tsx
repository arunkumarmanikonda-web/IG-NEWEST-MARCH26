...
// â”€â”€ ARTICLE IMAGES â€” India Gully project images only â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// All images sourced from active India Gully mandate properties only.
// No generic stock / Unsplash images used.
const CAT_IMAGES: Record<string, string> = {
  // Hotel Rajshree & Spa, Chandigarh â€” Real Estate / Commercial article header
  'Real Estate':             '/static/mandates/chandigarh/chandigarh-img2.webp',
  // WelcomHeritage Santa Roza, Kasauli â€” Heritage & Entertainment context
  'Entertainment':           'https://www.welcomheritagehotels.in/wp-content/uploads/2024/09/santa-roza-overview.jpg',
  // Hotel Rajshree interior â€” HORECA / F&B procurement context
  'HORECA':                  '/static/mandates/chandigarh/chandigarh-img1.webp',
  // Maple Resort Chail â€” mountain asset, suitable for Debt / Special Situations
  'Debt & Special Situations':'/static/mandates/chail/chail-slider1.jpg',
  // Maple Resort exterior â€” Retail / leasing context
  'Retail':                  '/static/mandates/chail/chail-slider2.jpg',
  // WelcomHeritage Santa Roza â€” Hospitality article header
...
<p>India's corporate occupier base has stabilised at a <strong>3.2-day average office week</strong> â€” a figure that has remained unchanged since Q2 2024. This equilibrium is driving a fundamental rethinking of space allocation:</p>
<ul>
...
<ul>
  ...
  <li>In-house restaurant and barista-quality cafÃ© operations</li>
...
<p>The incremental construction cost of these specifications runs at â‚¹180-250 per sq ft over baseline â€” recoverable through a 12-18% rental premium over the project lifecycle.</p>
...
<p><strong>Delhi NCR</strong>: Aerocity and Central Delhi corridors are commanding â‚¹8,500-10,500 per sq ft for hospitality-grade office. Demand driven by MNCs, PSUs and financial services.</p>
<p><strong>Mumbai (BKC)</strong>: Premium plateaued at â‚¹22,000-28,000 per sq ft for Grade-A. Mixed-use with boutique hotel commands 18% premium; supply constrained.</p>
...
`,
  },
  {
    ...
    body: `
<h2>Introduction</h2>
<p>India's entertainment real estate sector â€” encompassing theme parks, family entertainment centres (FECs), waterparks, gaming zones, multiplex-anchored destination retail, and integrated entertainment destinations â€” operates at the intersection of <strong>six distinct regulatory frameworks</strong>. Navigating this complexity is one of the primary risks for promoters and investors.</p>
...
<p>Mixed-use entertainment destinations incorporating restaurants, bars, and event spaces are subject to state excise policy. Licensing timelines vary from 3 months (Goa) to 18+ months (Delhi, Maharashtra for bar licenses). F&B is typically the highest-margin component of an entertainment destination â€” regulatory delays here directly impact revenue projections.</p>
...
<p>India's branded hospitality sector is in the midst of its most aggressive geographic expansion since the mid-2000s. Every major hotel brand â€” Marriott, Radisson, IHG, Lemon Tree, Cygnett, Regenta â€” has active development pipelines extending into Tier 2 and Tier 3 cities. India Gully, with active hotel management and HORECA supply mandates across Chandigarh, Kasauli, Chail, Jaipur, Jodhpur, Coimbatore, and Kochi, is uniquely positioned to observe the supply chain challenges this expansion creates.</p>
...
<ul>
  ...
  <li><strong>â‚¹50 Cr+</strong> procurement managed across 15+ hotel properties</li>
...
<ol>
  <li><strong>Pre-packaged Resolution Plans (PPIRP) Extended to Hotel Assets</strong>: Previously limited to MSMEs, the PPIRP mechanism is now available for hospitality assets below â‚¹100 Cr enterprise value, significantly accelerating timelines for mid-scale hotel insolvency.</li>
...
<ul>
  ...
  <li><strong>Operational hotel rate</strong> (properties generating some revenue during CIRP): 71%, up from 45% in 2019 â€” improved IRP protocols</li>
  <li><strong>Successful resolution rate</strong>: 38% (national average for all sectors: 29%) â€” hospitality outperforms</li>
</ul>
...
<p>Original promoters â€” often having addressed the original stress â€” submit competitive resolution plans. Regulatorily constrained but still a significant segment.</p>
...
<ol>
  ...
  <li><strong>Months 3-12</strong>: Brand on-boarding. Select and negotiate hotel brand. This is India Gully's primary advisory role â€” we have active relationships with every relevant brand and can compress brand on-boarding from 12 to 6 months in many cases.</li>
  <li><strong>Months 12-18</strong>: Refurbishment and reopening. Targeted FF&E / OS&E investment of â‚¹8-15L per key. India Gully's HORECA division executes this.</li>
...
<h2>Conclusion</h2>
<p>The IBC 2025 amendments, combined with the compressed resolution timelines now being achieved at NCLT, make this an exceptionally favourable period for strategic acquirers of distressed hospitality assets. India Gully's integrated advisory â€” transaction advisory, brand on-boarding, and HORECA supply â€” provides the end-to-end capability required to execute a distressed acquisition and create post-resolution value efficiently.</p>
`,
  },
  {
...
<p>Hotels and premium offices create a captive, high-spending population. Hotel guests with dining spend average 2.8Ã— the retail spend of regular mall visitors. Office workers within integrated developments spend â‚¹1,200-1,800 per week on food and convenience retail â€” a highly predictable revenue stream for mall operators and their tenants.</p>
...
<ul>
  ...
  <li>Hotel pre-opening enquiry volume was 4Ã— that of standalone hotel comparable</li>
...
<p>Tenants in integrated developments are increasingly seeking <strong>cross-asset access rights</strong> â€” office tenants negotiating parking rights in the mall structure, hotel guests receiving preferential retail rates, loyalty programme integration across all components. These require multi-party lease agreements that most retail lease professionals are not structured to handle.</p>
<h3>Revenue Participation</h3>
<p>Mixed-use developers are moving from pure fixed rent to <strong>base rent + revenue share</strong> models â€” particularly for F&B anchors and entertainment components. India Gully structures these as: Base = 65% of market rent + 4-7% of net revenue above a turnover threshold.</p>
<h3>Green Lease Provisions</h3>
<p>New integrated developments in India's top 5 cities are incorporating green lease provisions covering energy consumption sharing, waste management obligations, and sustainability reporting â€” a requirement emerging from ESG-mandated institutional investors.</p>
...
<p>India's branded hotel supply is significantly skewed toward the luxury and upper-upscale segments. The <strong>mid-scale branded segment</strong> (3-star, â‚¹3,000-6,000 average daily rate) represents the most significant supply-demand gap in the Indian hospitality market. Demand is robust and growing at 12-15% per annum; branded supply growth is 8-10%.</p>
...
<ul>
  <li>Land (0.6-0.8 acres, commercial zone): â‚¹3.5-7 Cr (city-dependent)</li>
  <li>Construction cost (80 keys, branded mid-scale standard): â‚¹18-24 Cr</li>
  <li>FF&E/OS&E (India Gully HORECA procurement): â‚¹4.5-6 Cr</li>
  <li>Pre-opening and working capital: â‚¹1.5-2 Cr</li>
  <li><strong>Total development cost: â‚¹27-39 Cr</strong> (â‚¹34-49L per key)</li>
</ul>

<h3>Revenue Assumptions (Year 3 Stabilised)</h3>
<ul>
  <li>Occupancy: 68-72% (branded mid-scale, Tier 2)</li>
  <li>Average Daily Rate: â‚¹3,800-4,800</li>
  <li>RevPAR: â‚¹2,580-3,456</li>
  <li>F&B contribution: 28-32% of total revenue</li>
  <li><strong>Total revenue Year 3: â‚¹8-11 Cr</strong></li>
</ul>

<h3>EBITDA and Returns</h3>
<ul>
  <li>Hotel EBITDA margin (branded mid-scale): 28-35%</li>
  <li>EBITDA Year 3: â‚¹2.2-3.9 Cr</li>
  <li>Yield on development cost: 8-13%</li>
  <li>Cap rate (mid-scale hotel, Tier 2): 8.5-10.5%</li>
  <li>Implied capital value at stabilisation: â‚¹21-46 Cr</li>
...
<ol>
  ...
  <li><strong>Dehradun / Haridwar</strong>: Religious and leisure tourism boom. Weekend demand spikes 3-4Ã—.</li>
...
<h2>Conclusion</h2>
<p>Greenfield mid-scale hotel development in India's Tier 2 markets offers a rare combination of structural demand growth, manageable capital requirements, and institutional-grade returns. India Gully's integrated offer â€” from site selection and brand on-boarding through HORECA procurement and operations advisory â€” provides the end-to-end support that first-time hotel developers require to execute successfully.</p>
`,
  },
  {
...
<ul>
  <li><strong>Pan-India RevPAR</strong>: â‚¹4,850 in FY24 â€” up 14% YoY, the highest since records began</li>
  <li><strong>Luxury/Upper-Upscale ADR</strong>: â‚¹12,200+ â€” up 18% YoY driven by corporate demand recovery and MICE resurgence</li>
  <li><strong>Occupancy (Branded, Pan-India)</strong>: 68.4% annual average; metro markets averaging 72-78%</li>
  <li><strong>Delhi NCR</strong>: Occupancy 74.2%, ADR â‚¹8,500, RevPAR â‚¹6,307</li>
  <li><strong>Mumbai</strong>: Occupancy 76.1%, ADR â‚¹10,200, RevPAR â‚¹7,762</li>
  <li><strong>Bengaluru</strong>: Occupancy 71.8%, ADR â‚¹7,800, RevPAR â‚¹5,600</li>
  <li><strong>Hyderabad</strong>: Occupancy 68.9%, ADR â‚¹7,200, RevPAR â‚¹4,961</li>
</ul>
...
<ul>
  ...
  <li><strong>Upscale (4-star)</strong>: The sweet spot for investment. RevPAR premium over mid-scale at 2.2Ã— with capex premium of only 1.5Ã—. IRR superiority of 300-500 bps.</li>
  ...
  <li><strong>Heritage / Boutique</strong>: India's fastest-growing segment by ADR growth. International leisure demand at premium ARR (â‚¹15,000-60,000/night). WelcomHeritage, Neemrana, Taj SeleQtions competing for quality assets.</li>
...
<p>The branded hotel supply pipeline in India stands at approximately 165,000 keys across all segments â€” the largest pipeline in Asia-Pacific excluding China. The mid-scale and economy segments account for 62% of the pipeline, reflecting promoter confidence in the mass-market segment.</p>
<p>Key supply markets in the pipeline: NCR (22,000 keys), Mumbai Metropolitan Region (18,000 keys), Bengaluru (14,000 keys), Hyderabad (11,000 keys), Goa (8,500 keys). Tier 2 markets â€” Coimbatore, Vizag, Bhubaneswar, Lucknow â€” account for 28% of the pipeline, the highest share in any five-year period.</p>
...
<ul>
  <li><strong>Airport expansion</strong>: 21 new or expanded airports under UDAN Phase 4 â€” each airport creates a branded hotel demand pocket within 18-24 months of opening</li>
...
<p>India Gully serves as transaction advisor, brand on-boarding partner, and HORECA procurement specialist across the full hospitality investment lifecycle. Our active 2024-2025 hospitality mandate pipeline spans 15+ projects across India, including WelcomHeritage Santa Roza Kasauli (â‚¹45 Cr), Hotel Rajshree Chandigarh (â‚¹70 Cr), Maple Resort Chail (â‚¹30 Cr), and a Heritage Hotel Structure in Jaipur (â‚¹20 Cr). We work with family offices, NBFCs, HNI investors, and strategic operators across the investment and development cycle.</p>
`,
  },
  {
    ...
    excerpt: 'India\'s entertainment real estate sector is entering a transformational phase, with â‚¹15,000+ Cr of integrated entertainment destinations in planning or execution. We analyse the structural drivers, developer strategies and investment thesis.',
    tags: ['Entertainment','Real Estate','Trends'],
    readTime: '12 min read',
    body: `
<h2>A Transformational Moment</h2>
<p>India's entertainment real estate sector is at an inflection point. After decades of incremental development â€” standalone multiplex complexes, small FECs, single-ride attractions â€” the country is entering an era of large-format, capital-intensive, experience-led entertainment destinations. More than â‚¹15,000 Cr of integrated entertainment projects are in planning or execution across the country as of 2024. India Gully is actively engaged across hospitality and mixed-use entertainment advisory mandates at the centre of this transformation.</p>

<h2>The Structural Drivers</h2>
<p>Four structural forces are converging to create this opportunity:</p>
<ul>
  <li><strong>Rising aspirational middle class</strong>: India's 350 million-strong aspirational middle class is the primary demand driver. Family leisure spend per outing has grown from â‚¹1,800 in 2019 to â‚¹3,200 in 2025. Spending on experiences has grown at 18% CAGR since 2019 versus 7% for goods.</li>
...
<ul>
  ...
  <li><strong>Pipeline additions (2024-2029)</strong>: 35+ large-format projects, estimated â‚¹38,000 Cr combined capital investment</li>
  <li><strong>Amusement park sector alone</strong>: â‚¹3,200 Cr market in FY2024, growing at 19% CAGR per NRAI estimates</li>
  <li><strong>Consumer spend on out-of-home entertainment</strong>: â‚¹1.2 lakh Cr annually, less than 3% penetrated by branded formats</li>
</ul>
...
<ul>
  <li><strong>Large-format theme parks & waterparks</strong>: â‚¹150-500 Cr capex, 50-200 acres, require IP licensing or proprietary IP, 8-12 year breakeven</li>
  <li><strong>Integrated mall-entertainment centres</strong>: â‚¹25-80 Cr entertainment component within larger mall/mixed-use, 15,000-50,000 sq ft FEC, 5-7 year breakeven</li>
  <li><strong>Standalone FECs</strong>: â‚¹8-35 Cr, 8,000-25,000 sq ft, family-oriented, anchor by bowling/trampoline/arcade, 3-5 year breakeven</li>
  <li><strong>Entertainment-hospitality hybrids</strong>: â‚¹40-120 Cr, combine F&B destination dining with entertainment programming, resort-entertainment in leisure catchments</li>
</ul>

<h2>Unit Economics: FEC P&L Model</h2>
<p>A 20,000 sq ft Tier 1 city FEC (â‚¹18-25 Cr capex) with India Gully benchmark assumptions:</p>
<ul>
  ...
  <li><strong>Footfall required for breakeven</strong>: 1,200-1,800 visitors/day on 300-day basis at â‚¹600-800 average ticket</li>
...
<ul>
  ...
  <li><strong>Infrastructure dependency</strong>: Road, metro, and utility access are critical success factors often underestimated in initial feasibility. A 20% traffic/catchment haircut for poor last-mile is conservative â€” reality can be 40-60%.</li>
  <li><strong>Regulatory complexity</strong>: Fire safety, amusement ride certification (PESO), food licensing (FSSAI), excise for F&B, local municipality NOCs â€” the regulatory stack for entertainment is 15-20 approvals. India Gully maintains a full regulatory checklist and vendor network for clearances.</li>
</ul>
...
<p>Hotel pre-opening procurement â€” covering FF&E (Furniture, Fixtures & Equipment), OS&E (Operating Supplies & Equipment), kitchen equipment, linen, uniform, and amenities â€” is consistently underestimated by first-time hotel developers. India Gully's HORECA practice has rectified procurement failures on 7 of our last 15 hotel mandates where the developer had initially self-procured without specialist support. Common result: deferred opening by 3-6 months, â‚¹80-200 Cr capex overrun on a 100-key property.</p>
...
<ol>
  <li>Brand standard specification â†’ Master specification list (India Gully: 500+ SKUs)</li>
  <li>Master spec â†’ Local adaptation (material availability, lead time, cost benchmarking)</li>
  <li>Local adaptation â†’ Vendor identification and shortlisting (India Gully vendor database: 50+ qualified suppliers)</li>
  <li>Vendor shortlisting â†’ Sample approval â†’ Order placement with payment milestones</li>
  <li>Order â†’ Delivery, inspection, snagging, and brand compliance sign-off</li>
</ol>

<h2>Vendor QC Framework</h2>
<p>India Gully's procurement practice applies a three-level QC framework:</p>
<ul>
  <li><strong>Level 1 â€” Pre-Qualification</strong>: Factory audit, GST registration, brand certifications, capacity verification, reference check from 3+ previous hotel projects. Only Level 1 qualified vendors receive RFQs.</li>
  <li><strong>Level 2 â€” Sample Approval</strong>: Physical samples reviewed against brand standard. Written approval from operator's procurement team required before order placement. No exceptions.</li>
  <li><strong>Level 3 â€” Delivery Inspection</strong>: India Gully site representative inspects every delivery against purchase order specifications. Rejections documented and replacement ordered at vendor cost.</li>
</ul>

<h2>Common Procurement Failures</h2>
<ul>
  <li><strong>Under-specification of kitchen equipment</strong>: Commercial kitchen specification requires brand, capacity, utility connection type (gas/electric/induction), and certification (BIS, CE) â€” not simply a product category. India Gully has seen â‚¹40-80 lakh kitchen equipment orders rejected by operators at inspection stage.</li>
  <li><strong>Linen quantity error</strong>: Correct par stock calculation is 3-4Ã— room count (in-use + laundry + reserve), not 2Ã—. A 100-key hotel needs 350-400 sets of each linen category. Understocking disrupts operations from Day 1 and requires expensive emergency procurement.</li>
  <li><strong>Amenity sourcing delays</strong>: Brand-specified amenity kits â€” particularly for IHG, Marriott, and Hyatt â€” often have 8-12 week lead times from authorised suppliers. Order 16 weeks before opening minimum.</li>
...
<ul>
  ...
  <li>Value engineering of specifications without compromising brand compliance â€” typically â‚¹15-25 lakh savings on a 100-key hotel FF&E budget</li>
...
<p>The primary causes of hotel insolvency in India are structural â€” making many assets operationally viable despite financial distress:</p>
<ul>
  <li><strong>Overleveraged development financing</strong>: Many properties were built at 70-80% debt, with DSCR assumptions requiring stabilised performance from Year 1 â€” a scenario that almost never holds for a greenfield hotel. India Gully estimates that 60% of CIRP hotels were fundamentally viable assets destroyed by excessive leverage, not operational failure.</li>
...
<ul>
  <li><strong>Acquisition discount</strong>: CIRP hotels typically transact at 35-55% discount to replacement cost (registered valuer assessment). For a hotel with â‚¹80 Cr replacement cost, a resolution plan at â‚¹36-52 Cr is typical.</li>
  ...
  <li><strong>Operational period value</strong>: The interim resolution period (typically 6-18 months) often results in deferred maintenance, depleted inventory, and staff attrition â€” these represent known costs the acquirer can pre-price in the plan.</li>
  <li><strong>Brand upside</strong>: An unbranded CIRP hotel in a strong demand location can achieve 22-38% RevPAR uplift within 12 months of brand on-boarding â€” the single largest value driver post-resolution.</li>
</ul>
...
<ul>
  <li><strong>Brand premium</strong>: RevPAR uplift of 22-38% from brand on-boarding. On a 50-key hotel at â‚¹3,500 ADR, this represents â‚¹15-25 lakh annual EBITDA addition at 70% occupancy.</li>
  <li><strong>Refurbishment ROI</strong>: Well-scoped refurbishment (â‚¹8-15 lakh per key) typically returns 4-6Ã— capital at stabilisation through ADR increase, extended brand agreement tenure, and improved online reviews driving direct bookings.</li>
...
<p>India Gully's integrated offer â€” transaction advisory + brand on-boarding + HORECA procurement â€” is uniquely positioned to execute the full post-resolution value creation playbook. Combined, these levers can generate equity IRRs of 22-35% on well-selected distressed hotel acquisitions.</p>
`,
  },
  {
...
<ul>
  <li><strong>F&B and dining</strong>: 25-32% of GLA (up from 18-22% in 2018) â€” the single biggest shift</li>
  <li><strong>Entertainment and leisure</strong>: 12-18% (up from 8-10%) â€” bowling, gaming, FEC, fitness</li>
  <li><strong>Fashion and apparel</strong>: 28-32% (down from 42-48%) â€” but premiumising upward</li>
  <li><strong>Beauty and wellness</strong>: 8-10% (up from 4-6%) â€” grooming, salons, wellness studios</li>
  <li><strong>Technology and electronics</strong>: 6-8% (stable)</li>
  <li><strong>Other specialty</strong>: Balance â€” stationery, books, specialty foods, concept stores</li>
</ul>
...
<ul>
  ...
  <li>F&B destination anchor (a â‚¹500+ cover dining concept) draws from a 25-35km catchment versus 15-20km for fashion retail</li>
...
<p>Entertainment anchors â€” multiplex, FEC, gaming zone, bowling â€” generate a measurable footfall premium for co-located retail. India Gully benchmark data from 8 active mall mandates:</p>
<ul>
...
<ul>
  ...
  <li><strong>Investment returns</strong>: Grade-A Tier 2 malls (â‚¹150-300 Cr development cost) achieve stabilised yields of 9-12% â€” significantly above Tier 1 (6-8%) â€” with lower vacancy risk.</li>
</ul>
...
<ul>
  <li><strong>Anchor tenants</strong>: Negotiate fit-out contribution (â‚¹800-1,200/sq ft for hypermarkets, â‚¹400-600/sq ft for apparel anchors) and minimum guarantee at 80% of market base rent for 9+9 year tenure</li>
...
<p>India's Tier 2 and Tier 3 cities represent the most significant hotel supply gap in Asia. Branded room supply per 100,000 population in cities like Coimbatore, Vizag, Bhubaneswar, Jammu, and Srinagar is 6-12 keys â€” versus 35-65 keys in Mumbai and Delhi, and 80-120 keys in comparable South-East Asian cities.</p>
<p>Demand is not the constraint â€” occupancy at existing branded properties in these markets regularly exceeds 80% on weekdays, with weekend spikes to 95%+. The constraint is supply: risk-averse developers, limited financing, and the absence of experienced development partners.</p>
...
<ul>
  ...
  <li><strong>Religious and pilgrimage tourism</strong>: India's pilgrimage circuit â€” Vaishno Devi, Tirupati, Shirdi, Amarnath, Char Dham â€” handles 200M+ visitors annually, the vast majority currently accommodated in unbranded guesthouses.</li>
  <li><strong>Wedding and MICE</strong>: India's wedding industry (â‚¹4.25 lakh crore) and growing corporate MICE market are driving demand for quality banquet and accommodation facilities in Tier 2 cities.</li>
  <li><strong>Government and PSU travel</strong>: State capitals and administrative centres generate consistent government and PSU travel â€” a captive, brand-agnostic demand segment.</li>
</ul>
...
<ul>
  <li><strong>Economy (â‚¹2,000-3,500 ADR)</strong>: Lemon Tree Express, Keys Lite, Ginger â€” lowest capital requirements, fastest ramp</li>
  <li><strong>Mid-Scale (â‚¹3,500-6,000 ADR)</strong>: Cygnett, Keys Select, Regenta, Pride â€” optimal for most Tier 2 markets</li>
  <li><strong>Upscale (â‚¹6,000-12,000 ADR)</strong>: Radisson Blu, Marriott Courtyard, Novotel â€” appropriate for state capitals and industrial Tier 2 cities</li>
</ul>
...
<ul>
  ...
  <li>DSCR requirement: 1.35Ã— from Year 3</li>
...
`,
  },
  {
    ...
    date: 'March 2026',
    title: 'The Mall-Hotel-Office Trinity: Mixed-Use Integration in Indian Retail Real Estate',
    excerpt: 'India\'s most successful new retail developments are no longer standalone malls â€” they are integrated destinations combining retail, hospitality, and office in a single master plan. We examine the economic logic, FSI advantages, and operational integration strategies that are redefining retail real estate in India.',
    tags: ['Retail', 'Mixed-Use', 'Real Estate', 'Hospitality'],
    readTime: '9 min read',
    body: `
<h2>The Economic Logic of Integration</h2>
<p>India's retail real estate sector is undergoing a fundamental structural shift. The standalone mall â€” once the dominant format â€” is losing ground to <strong>integrated mixed-use destinations</strong> that combine retail anchors, branded hotels, and Grade-A office in a single master-planned development. India Gully's advisory work across eight active mixed-use mandates in 2025-26 has crystallised three compelling economic arguments for integration:</p>
<ol>
  <li><strong>Retail uplift from hotel guests</strong>: Hotel guests within an integrated development spend 2.8Ã— more in the retail podium than casual footfall. The captive guest spend on F&B, lifestyle, and wellness creates a baseline revenue floor that is independent of the external retail cycle.</li>
...
<ul>
  ...
  <li><strong>Hotel enquiry volume</strong>: 4Ã— standalone hotel benchmark for corporate group bookings, driven by adjacency to office occupiers</li>
...
<p>Tenants in integrated developments are increasingly seeking <strong>cross-asset access rights</strong> â€” office tenants negotiating parking rights in the retail podium, hotel corporate rate agreements for office occupier employees, and retail tenant access to hotel fitness and spa at preferential rates. These cross-amenity lease structures are a powerful retention tool and a competitive differentiator in the leasing market.</p>
...
<p>India Gully's pipeline analysis indicates that the next generation of Indian retail real estate investment will be dominated by mixed-use integrated formats. Our active retail mandate pipeline includes three mixed-use developments totalling â‚¹2,400 Cr in project cost â€” all incorporating the mall-hotel-office trinity. The yields being achieved â€” retail cap rates of 7.5-9.0%, hotel yield on cost of 9-11%, office cap rates of 7-8% â€” are each superior to standalone format benchmarks, with the combination providing a risk-adjusted return profile that is compelling for domestic and institutional investors.</p>
`,
  },
  {
...
<p>India's Tier 2 and Tier 3 hotel markets â€” cities like Chandigarh, Bhubaneswar, Coimbatore, Jammu, Nashik, and Mysuru â€” are experiencing their strongest period of branded hotel supply growth in a decade. Yet the supply chain infrastructure required to commission and operate these properties has not kept pace with development velocity.</p>
...
<ul>
  ...
  <li><strong>Cost impact</strong>: Pre-opening procurement costs in unmanaged Tier 2 projects run 18-25% above Tier 1 benchmarks â€” a paradox, since land and construction costs in Tier 2 are lower. The supply chain premium erodes a significant portion of the location cost advantage.</li>
</ul>
...
<ul>
  ...
  <li><strong>â‚¹50 Cr+ total procurement</strong> managed through the model (cumulative)</li>
...
<p>India Gully's HORECA procurement support for Hotel Rajshree &amp; Spa â€” a 41-key boutique hotel with spa in Chandigarh â€” illustrates the model in practice. The property was acquired through India Gully's advisory mandate and required a full OS&amp;E and partial FF&amp;E refresh for brand repositioning:</p>
<ul>
...
<p>India Gully's HORECA division operates across the full value chain: procurement (FF&amp;E, OS&amp;E, kitchen equipment), operations advisory (SOPs, F&amp;B menu engineering, yield management), and supply continuity (ongoing consumables replenishment). This ecosystem approach â€” from pre-opening to steady-state operations â€” is particularly valuable for independent operators and family-office hotel owners in Tier 2 markets who lack the internal expertise of branded hotel management companies.</p>
...
`,
  },
  {
    ...
    body: `
<h2>Executive Summary</h2>
<p>India's organised retail real estate sector in 2026 is bifurcating sharply. The top 15% of mall stock â€” Grade-A developments in metro CBDs and premium suburban corridors â€” is virtually fully leased, with brands competing for space and rental reversions of 12-18% on lease renewal. The bottom 40% of existing mall stock faces vacancy rates above 25%, anchor tenant exodus, and structural repositioning requirements. Understanding this hierarchy â€” and selecting the right assets â€” is the central challenge for both retail brands and real estate investors.</p>
...
<p>The top 8-10 malls nationally â€” DLF Emporio, Select Citywalk, Palladium, Phoenix MarketCity Mumbai â€” occupy a category apart. Vacancy rates are effectively zero; waitlists for anchor and flagship space run 18-36 months. Rental premiums of 80-120% over city averages are sustained by irreplaceable footfall (30,000-70,000 daily visitors) and unmatched brand visibility. Investment yields have compressed to 5.5-6.5%, reflecting institutional quality comparable to gateway European retail real estate.</p>

<h3>Tier II: Premium Regional Malls</h3>
<p>15-20 malls in the 6 major metros â€” DLF CyberHub, Pacific Mall Tagore Garden, Nexus Elante Chandigarh â€” deliver consistent Grade-A performance with footfall of 12,000-28,000 daily. Vacancy runs 3-8%. Rental levels of â‚¹150-300 per sq ft per month for premium inline are achievable. These assets attract both international brand entries and domestic premiumisation plays.</p>

<h3>Tier III: Quality Neighbourhood Malls</h3>
<p>The largest segment by number â€” well-located, single-catchment malls of 3-5 lakh sq ft in Tier 1 cities. Performance varies significantly by micro-market. Anchor-tenant quality is the key differentiator: malls anchored by Reliance / D-Mart / premium cineplex outperform peers by 35-45% on inline brand performance. Vacancy: 8-15%. Rental: â‚¹80-150 per sq ft per month for inline.</p>

<h3>Tier IV: Transitional Assets</h3>
<p>Legacy malls (2008-2015 vintage) in secondary micro-markets facing the omnichannel disruption most acutely. Many have lost 1-3 anchor tenants in the post-COVID period; vacancy of 20-35% is common. These assets require repositioning â€” conversion of dead retail into F&B, entertainment, gym/wellness, co-working, or hotel use. India Gully has active advisory mandates involving three such repositioning projects totalling 8 lakh sq ft of gross leasable area.</p>

<h3>Tier V: Distressed Assets</h3>
<p>Poorly located, structurally undermined retail assets with vacancy above 40%. Resolution is primarily through Tier IV conversion (full repurposing) or debt resolution via IBC. India Gully's Debt & Special Situations practice has engaged on three such assets in the â‚¹35-120 Cr range over the past 24 months.</p>
...
<ul>
  ...
  <li>Brands in the â‚¹3,000-8,000 ASP (average selling price) range are the most active space-seekers â€” this "accessible premium" segment is growing faster than both mass and luxury</li>
  <li>Home and lifestyle categories â€” D2C furniture, artisanal home dÃ©cor, premium kitchenware â€” are the fastest-growing categories for physical retail expansion</li>
...
<ul>
  ...
  <li><strong>Returns reduction</strong>: Brands with physical presence show 35-42% lower return rates on online orders â€” customers who can touch and try in-store order with more confidence online</li>
...
`,
  },
  {
    ...
    excerpt: 'India\'s hospitality sector carries an estimated â‚¹22,000-28,000 Cr of stressed debt, concentrated in mid-market hotels built in the 2008-2015 cycle. The post-COVID recovery has been uneven: premium assets have recapitalised; sub-optimal assets face IBC proceedings or promoter distress. India Gully\'s Debt & Special Situations practice maps the opportunity.',
    tags: ['Debt & Special Situations', 'Hospitality', 'IBC', 'Real Estate'],
    readTime: '11 min read',
    body: `
<h2>Executive Summary</h2>
<p>India's hospitality sector recovery from COVID-19 has been structurally uneven. Tier-1 branded hotels, airport-proximate properties, and heritage assets have delivered strong RevPAR recovery â€” many exceeding 2019 benchmarks by 15-25% in nominal terms. However, the mid-market hotel cohort built in the infrastructure and consumption boom of 2008-2015 carries structural vulnerabilities that the COVID shock exposed and the recovery has not fully healed: sub-optimal locations, over-leveraged capital structures, deferred capex, and in some cases promoter distress that has diverted management attention from hotel operations.</p>
<p>For special situations investors â€” family offices, credit funds, and strategic acquirers â€” this creates an investable opportunity in the â‚¹15-150 Cr per asset range, a segment that is too small for institutional PE but too complex for conventional property investors. India Gully's Debt & Special Situations vertical, active since 2023, has engaged on 8 assets in this segment with a combined debt exposure of â‚¹380 Cr.</p>
...
<ul>
  <li><strong>Total hospitality sector bank debt</strong>: Approximately â‚¹1,10,000-1,20,000 Cr (scheduled commercial banks + HFCs + NBFCs)</li>
  <li><strong>Gross NPA + SMA-2 (stressed) cohort</strong>: Estimated â‚¹22,000-28,000 Cr (19-23% of total hospitality sector lending)</li>
  <li><strong>NCLT admitted cases</strong>: 280+ hospitality-sector CIRPs active as of Q4 FY25, with aggregate admitted claims of â‚¹14,200 Cr</li>
  <li><strong>Pre-IBC settlements (OTS, restructuring)</strong>: India Gully estimates a further â‚¹8,000-14,000 Cr in pre-admission restructuring being managed bilaterally between promoters and lenders</li>
</ul>
...
<h3>1. Pre-NPA OTS Acquisitions (â‚¹15-60 Cr ticket)</h3>
<p>Assets where promoter distress is evident but the loan has not yet been classified NPA. Banks and NBFCs are willing to negotiate OTS at 55-70 cents on the rupee for early settlement. The acquirer receives a clean asset (no IBC overhang), operational continuity, and the ability to install new management immediately. India Gully acts as transaction advisor â€” structuring the OTS, negotiating with lenders, and connecting acquirers with franchise partners for re-branding.</p>

<h3>2. Post-IBC Resolution (â‚¹20-80 Cr ticket)</h3>
<p>Assets that have gone through IBC but failed to attract a resolution applicant in the initial CIRP. Liquidation assets â€” typically available at 40-60% of NCLT-assessed liquidation value â€” offer the deepest value but require full operational rebuild. India Gully's value-add framework for these assets: assess structural integrity, identify optimal brand/franchise, model 36-month recovery P&L, and connect with operators willing to manage on a management contract rather than requiring an upfront fee. Hotel Rajshree, Chandigarh (India Gully mandate) is an example of a successful post-distress operational restoration.</p>

<h3>3. Promoter Equity Restructuring (â‚¹8-35 Cr ticket)</h3>
...
<ul>
  ...
  <li><strong>Valuation and structuring</strong>: India Gully's hospitality-specific valuation methodology â€” incorporating brand repositioning value, RevPAR recovery modelling, and capex-adjusted DCF â€” provides a more accurate intrinsic value estimate than generic real estate valuation</li>
...
<p>For special situations investors seeking exposure to India's hospitality sector at below-replacement-cost pricing, India Gully offers a differentiated advisory capability that combines transaction execution skill with deep hospitality operating expertise â€” a combination that is rare in the Indian advisory market.</p>
`,
  },
  // â”€â”€ NEW PHASE 17B ARTICLES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    id: 'horeca-cloud-kitchen-india-2026',
    category: 'HORECA',
    date: 'March 2026',
    title: 'Cloud Kitchens & Dark Stores: India\'s HORECA Infrastructure Revolution',
    excerpt: 'India\'s food delivery ecosystem has crossed â‚¹1,00,000 Cr in annual GMV, yet the kitchen infrastructure underpinning it remains fragmented and capital-inefficient. India Gully\'s HORECA advisory practice examines the cloud kitchen model, dark store integration, and the investment opportunities emerging at the intersection of real estate and foodservice.',
    tags: ['HORECA', 'Cloud Kitchen', 'Food Delivery', 'Real Estate'],
    readTime: '9 min read',
    body: `
<h2>Executive Summary</h2>
<p>India's online food delivery market crossed â‚¹1,00,000 Cr in annualised GMV in Q3 FY26, driven by Swiggy, Zomato, and an increasingly sophisticated set of quick-commerce platforms. Yet the physical infrastructure enabling this digital economy â€” the kitchen, the cold chain, the last-mile dark store â€” remains the least institutionalised segment of the entire value chain.</p>
...
<ul>
  ...
  <li><strong>Zomato Hyperpure</strong>: B2B ingredient supply business now processing â‚¹2,400 Cr+ annually, servicing 50,000+ restaurant partners</li>
  <li><strong>Blinkit (Zomato)</strong>: 800+ dark stores across 40+ cities; average dark store area 1,800-3,500 sq ft; lease terms 3-5 years at â‚¹45-120 per sq ft per month in Tier-1 micro-markets</li>
</ul>
...
<ul>
  <li><strong>Platform-operated hubs</strong>: Rebel Foods (Faasos, Behrouz, Ovenstory), EatClub â€” vertically integrated multi-brand operators with 300-600 sq ft standardised kitchen modules</li>
  <li><strong>Landlord-operated shared kitchens</strong>: Co-working-style shared kitchen infrastructure (Kitchens@, The Kitchens by Swiggy) leased to F&B brands at â‚¹12,000-35,000 per station per month</li>
  ...
  <li><strong>Ghost kitchens in hotel basements</strong>: India Gully has actively advised 3 hotel owners on monetising under-utilised basement kitchen infrastructure for cloud kitchen sub-leasing â€” generating â‚¹80,000-1.8 Cr per year in incremental revenue</li>
</ul>
...
<ol>
  <li><strong>Tier A: Hub Dark Kitchens</strong> (2,500-8,000 sq ft): Multi-brand production hubs in industrial or commercial zones; ground floor preferred; loading bay mandatory; 3-phase power (80-150 kW); monthly lease â‚¹20-60 per sq ft in Tier-1</li>
  <li><strong>Tier B: Satellite Cloud Kitchens</strong> (400-1,200 sq ft): Delivery-radius extension units; typically in basement or mezzanine of existing commercial buildings; monthly lease â‚¹40-120 per sq ft depending on micro-market</li>
  <li><strong>Tier C: Dark Stores</strong> (1,500-4,000 sq ft): Ground-floor retail with 15-minute delivery access; cold storage (0-4Â°C zone) mandatory; monthly lease â‚¹60-180 per sq ft in high-demand micro-markets</li>
...
<ul>
  ...
  <li><strong>Infrastructure requirements</strong>: 3-phase power, ventilation compliance, ground-floor vehicle access â€” these structural requirements limit eligible buildings to 15-25% of total commercial stock in most micro-markets</li>
</ul>
...
<ul>
  ...
  <li><strong>Asset repositioning</strong>: Ground-floor retail with 30%+ vacancy in Tier-1 micro-markets can achieve full occupancy through HORECA-format conversion at â‚¹150-400 per sq ft capex</li>
</ul>
...
<ul>
  <li><strong>Shared kitchen platform</strong>: â‚¹2-8 Cr investment in 3,000-6,000 sq ft shared kitchen infrastructure; payback 28-42 months at 75%+ utilisation; multiple revenue streams (station rent, ingredient supply, licensing)</li>
  ...
  <li><strong>Technology stack for HORECA operators</strong>: Order aggregation, inventory management, menu engineering and customer analytics tools for cloud kitchen operators; SaaS opportunity with â‚¹8,000-25,000 per month ARPU</li>
</ul>
...
`,
  },
  {
    ...
    excerpt: 'India now hosts 850+ branded hotel projects across 25+ international and domestic flags. For hotel owners navigating the affiliation decision â€” IHG, Marriott, Hyatt, Radisson, Choice, OYO Townhouse, or homegrown brands â€” the choice has profound implications for RevPAR, capex requirement, management contract terms, and exit value. India Gully maps the landscape.',
    tags: ['Hospitality', 'Hotel Brands', 'Management Contracts', 'Investment'],
    readTime: '12 min read',
    body: `
<h2>Executive Summary</h2>
<p>India's branded hotel pipeline has expanded dramatically in the post-COVID recovery cycle. As of Q1 2026, the country's 850+ branded hotel projects represent a market where the affiliation decision â€” which flag to fly, on what contractual terms, for what duration â€” is one of the most consequential strategic choices a hotel owner can make.</p>
...
<ul>
  ...
  <li><strong>WelcomHeritage (ITC)</strong>: Heritage and boutique positioning; relevant specifically for palace, fort, and heritage property owners. India Gully has an active mandate â€” WelcomHeritage Santa Roza, Kasauli â€” demonstrating the brand's value for appropriate assets.</li>
</ul>

<h3>Midscale & Economy Aggregators</h3>
<ul>
  <li><strong>OYO</strong>: Franchise-light model at economy segment (â‚¹800-2,500 ADR). 3,000+ properties nationally. Rapid customer acquisition through platform; significant brand reputation risks. India Gully recommends OYO only for assets unable to qualify for conventional brands.</li>
...
<ol>
  ...
  <li><strong>Incentive fee</strong>: 6-10% of GOP (Gross Operating Profit) after a fixed owner's priority return (typically 8-10% of invested capital or total investment). The incentive fee structure is where most owner-operator disputes originate â€” ensure GOP definition, capex treatment, and owner's priority are clearly defined.</li>
  <li><strong>Operator performance guarantee</strong>: Minimum RevPAR (Revenue Per Available Room) or NOI (Net Operating Income) guarantee by the operator, with termination rights if missed for 2-3 consecutive years. Not all operators offer performance guarantees â€” Marriott and IHG do in competitive situations; OYO and budget operators typically do not.</li>
...
<ul>
  <li>IHG Holiday Inn Express: â‚¹18-25 lakh per key (renovation to brand standard for existing hotel)</li>
  <li>Marriott Courtyard / Fairfield: â‚¹22-35 lakh per key</li>
  <li>Hyatt Place / Centric: â‚¹28-42 lakh per key</li>
  <li>Lemon Tree / Goldfinch: â‚¹12-20 lakh per key</li>
  <li>Choice Hotels (Quality Inn): â‚¹8-15 lakh per key</li>
</ul>
<p>Owners must model the full risk-adjusted return including brand capex before signing a management contract â€” India Gully consistently finds that aspirational brand selection that exceeds the market's willingness to pay destroys owner value.</p>
...
`,
  },
  {
    ...
    excerpt: 'India\'s entertainment real estate pipeline for 2026-29 includes 35+ large-format destination projects across family entertainment, sports, gaming, and experiential retail. The development economics of these assets are complex â€” high capex, non-standard valuation, and operator-dependency. India Gully maps the framework for developers and investors.',
    tags: ['Entertainment', 'Real Estate Development', 'FEC', 'Investment'],
    readTime: '10 min read',
    body: `
<h2>Executive Summary</h2>
<p>India's entertainment real estate â€” encompassing family entertainment centres (FECs), theme parks, waterparks, bowling alleys, go-karting tracks, trampoline parks, virtual reality arcades, and integrated entertainment destinations â€” is at an inflection point. Consumer spending on experiential leisure is growing at 18-22% annually (CRISIL, 2025), driven by a young population, rising disposable incomes, and the 'experience economy' shift that followed COVID-19.</p>
<p>Yet despite strong demand fundamentals, entertainment real estate development economics remain complex: high capex, unconventional asset valuation, operator dependency, and a thin domestic institutional equity market. India Gully's entertainment advisory practice â€” active on 5 entertainment destination mandates totalling â‚¹280 Cr in project value â€” presents a development framework for operators and investors in this space.</p>
...
<ol>
  <li><strong>Large-format theme parks / waterparks</strong> (â‚¹150-500 Cr): Adlabs Imagica, Wonderla â€” high capex, high barrier to entry, strong cash-on-cash returns at maturity (12-18% CoC at 70% occupancy) but 4-7 year payback period and significant operational complexity</li>
  <li><strong>Integrated entertainment centres in malls</strong> (â‚¹25-80 Cr): FECs, bowling, arcade gaming, trampoline parks within mall anchoring space â€” mall anchor tenant economics with revenue share structures; lower capex but dependent on mall traffic</li>
  <li><strong>Standalone destination FECs</strong> (â‚¹8-35 Cr): Go-karting tracks, adventure zones, escape rooms, indoor sports facilities with F&B â€” India Gully's most active advisory segment; mid-ticket capex with 3-5 year payback at adequate utilisation</li>
  <li><strong>Entertainment hospitality hybrids</strong> (â‚¹40-120 Cr): Resort properties with integrated entertainment â€” adventure activities, gaming zones, live entertainment venues â€” increasingly relevant as India's MICE and leisure travel grows</li>
</ol>
...
<ul>
  <li><strong>Family leisure spend growth</strong>: Average family entertainment spend per outing has grown from â‚¹1,800 in 2019 to â‚¹3,200 in 2025 (FICCI, 2025). The per-outing basket is expanding as consumers trade up from bowling alleys to multi-format FECs with F&B integration.</li>
  <li><strong>Youth-driven experiential demand</strong>: 18-35 age cohort (India's largest demographic) is the most active entertainment consumer â€” VR arcades, e-sports centres, escape rooms, and social gaming formats skew strongly to this cohort</li>
  <li><strong>Corporate MICE demand</strong>: Post-COVID, corporate events and team-building activities have shifted toward experiential formats â€” go-karting, bowling tournaments, escape room team events. India Gully's entertainment clients report MICE contributing 18-35% of revenue at optimal locations</li>
</ul>
...
<ul>
  <li><strong>Go-karting track</strong> (400m outdoor): â‚¹3.5-6 Cr including track, barriers, safety systems, timing equipment, and basic F&B infrastructure</li>
  <li><strong>Trampoline park</strong> (8,000-15,000 sq ft): â‚¹2.8-4.5 Cr including trampoline installation, foam pits, ninja warrior courses, and structural upgrades</li>
  <li><strong>Bowling alley</strong> (8 lanes): â‚¹4-7 Cr including lane equipment (AMF/Brunswick), flooring, scoring systems, seating, and F&B</li>
  <li><strong>Indoor climbing wall</strong> (4,000-8,000 sq ft): â‚¹1.8-3.2 Cr including wall structures, safety systems, and equipment</li>
  <li><strong>VR / gaming zone</strong> (3,000-6,000 sq ft): â‚¹2.5-5 Cr including VR hardware, gaming pods, cabling, and digital infrastructure</li>
  <li><strong>Integrated FEC</strong> (25,000-50,000 sq ft, multiple formats): â‚¹18-40 Cr including all entertainment formats, F&B build-out, and interior design</li>
</ul>

<h3>Revenue Model</h3>
<p>Entertainment destination revenue models have three layers:</p>
<ol>
  <li><strong>Activity revenue</strong>: Per-session charges (go-kart laps, bowling games, VR sessions) â€” typically 55-65% of total revenue; highest margin (70-80% gross margin)</li>
  <li><strong>F&B revenue</strong>: Restaurant, cafÃ©, bar â€” typically 25-35% of total revenue; gross margin 60-70% for mid-market F&B offering</li>
  <li><strong>Ancillary revenue</strong>: Birthday packages, corporate MICE bookings, membership programs, retail (branded merchandise) â€” typically 10-20% of total revenue; highest contribution margin</li>
</ol>
<p>India Gully's revenue model for a â‚¹15 Cr standalone FEC (25,000 sq ft, 3 entertainment formats + F&B) projects stabilised Year 3 revenue of â‚¹6-8 Cr against operating cost of â‚¹3.5-4.5 Cr, implying EBITDA of â‚¹2-3.5 Cr (30-45% margin) and a project-level IRR of 18-26% over a 7-year horizon.</p>
...
// â”€â”€ INSIGHTS INDEX â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
app.get('/', (c) => {
...
<!-- â•â• INSIGHTS HERO â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
<div class="hero-dk">
  ...
  <div class="wrap" style="position:relative;">
    <div style="max-width:720px;" class="fu">
      ...
      <p class="lead-lt" style="max-width:600px;margin-bottom:2.75rem;">Market research, sector analysis and operational insights from India Gully's advisory practice â€” drawn from active mandates across hospitality, real estate, retail and entertainment.</p>
  ...
  <div class="wrap" style="padding:0;">
    <div class="ins-stats-bar">
      ${[
        ...
        { n: 'â‚¹2,100 Cr+', l: 'Active Pipeline' },
...
<div class="sec-wh" id="insightsContent" style="padding-top:6rem;">
  <div class="wrap">
    ...
    <!-- Featured Card â€” editorial magazine layout -->
...
<!-- â•â• SUBSCRIBE â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
  ...
  <div class="wrap">
    <div style="background:var(--ink);padding:4rem;display:grid;grid-template-columns:1fr 1fr;gap:4rem;align-items:center;" class="mob-stack">
      <div>
        ...
        <p class="lead-lt" style="font-size:.9rem;">Receive our sector research, market updates and mandate alerts directly â€” for qualified investors, developers and industry professionals.</p>
...
`
  ...
  return c.html(layout('Insights & Research â€” India Gully', content, {
...
// â”€â”€ ARTICLE DETAIL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
app.get('/:id', (c) => {
...
<!-- â•â• ARTICLE HERO â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
...
<!-- â•â• ARTICLE BODY â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•== -->
<div style="background:var(--parch);padding:5rem 0;">
  <div class="wrap" style="display:grid;grid-template-columns:1fr 320px;gap:4rem;align-items:start;max-width:1200px;" class="listing-layout">
    ...
    <!-- â”€â”€ ARTICLE CONTENT â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
    <article>
      ...
      <div style="margin-top:3.5rem;padding-top:2rem;border-top:1px solid var(--border);">
        ...
        <div style="display:flex;align-items:center;gap:.75rem;flex-wrap:wrap;margin-bottom:1.75rem;">
          ...
          <a href="https://twitter.com/intent/tweet?url=https://india-gully.pages.dev/insights/${article.id}&text=${encodeURIComponent(article.title + " â€” India Gully Research")}&via=IndiaGully" target="_blank" rel="noopener" title="Share on X / Twitter"
        ...
        <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:1.25rem;">
          <div style="font-size:.78rem;color:var(--ink-muted);">Published by <strong style="color:var(--ink);">India Gully Research</strong> Â· ${article.date} Â· <span style="color:var(--gold);"><i class="fas fa-clock" style="font-size:.68rem;"></i> ${article.readTime}</span></div>
    ...
    <div style="position:sticky;top:calc(var(--nav-h) + 1.5rem);display:flex;flex-direction:column;gap:1.25rem;" class="listing-sidebar">
      ...
      <div style="background:linear-gradient(135deg,var(--ink) 0%,#1a1a2e 100%);border:1px solid rgba(184,150,12,.2);padding:1.5rem;position:relative;overflow:hidden;">
        ...
        <p style="font-size:.7rem;color:rgba(255,255,255,.5);line-height:1.7;margin-bottom:1rem;">Our research draws directly from active advisory mandates â€” real transactions, real data, no theoretical models.</p>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:.5rem;margin-bottom:1rem;">
          ${[
            { n: '8+', l: 'Yrs Advisory' },
            { n: '40+', l: 'Contracts' },
            { n: 'â‚¹2,100 Cr', l: 'Pipeline' },
            { n: '6', l: 'Sectors' },
        ...
        <div style="font-size:.62rem;color:rgba(255,255,255,.3);border-top:1px solid rgba(255,255,255,.06);padding-top:.75rem;display:flex;align-items:center;justify-content:space-between;">
          ...
          <span>India Gully Â· CIN U74999DL2017PTC323237</span>
        </div>
      </div>
      ...
      <div style="background:var(--parch);border:1px solid var(--border);padding:1.25rem;" id="toc-box">
        ...
        <div id="toc-list" style="display:flex;flex-direction:column;gap:.4rem;">
          <span style="font-size:.75rem;color:var(--ink-faint);">Loadingâ€¦</span>
        </div>
      </div>
      ...
      <div style="background:#fff;border:1px solid var(--border);padding:1.5rem;">
        ...
        <div style="display:flex;flex-direction:column;gap:1rem;">
          ...
          <a href="/insights/${r.id}" style="display:flex;flex-direction:column;gap:.35rem;padding-bottom:1rem;border-bottom:1px solid var(--border);text-decoration:none;" onmouseover="this.querySelector('h4').style.color='var(--gold)'" onmouseout="this.querySelector('h4').style.color='var(--ink)'">
            ...
            <span style="font-size:.68rem;color:var(--gold);font-weight:600;letter-spacing:.06em;">Read â†’</span>
          </a>`).join('')}
        </div>
      </div>` : ''}
...
<!-- â•â• MORE INSIGHTS â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
${relatedArticles.length ? `
      ...
      <a href="/insights/${r.id}" style="display:block;background:#fff;border:1px solid var(--border);overflow:hidden;transition:all .25s;text-decoration:none;"
        ...
        <div style="padding:1.1rem;">
          ...
          <div style="display:flex;align-items:center;justify-content:space-between;margin-top:.75rem;">
            ...
            <span style="font-size:.68rem;color:var(--gold);font-weight:600;">Read â†’</span>
          </div>
        </div>
      </a>`).join('')}
    </div>
...
(function() {
  ...
  window.igSubscribe = function() {
    ...
    if (btn) { btn.disabled = true; btn.innerHTML = '<i class="fas fa-circle-notch fa-spin" style="margin-right:.4rem;"></i>Subscribingâ€¦'; }
    fetch('/api/subscribe', {
      method: 'POST',
