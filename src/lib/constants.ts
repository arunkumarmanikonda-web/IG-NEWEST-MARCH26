...
export const STATS = [
  { value: 'INR 2,100 Cr+', label: 'Mandate Pipeline Under Management' },
...
export const LISTINGS = [
  ...
  // ── 5. Heritage Hotel Structure, Jaipur ──────────────────────────────────
  {
    ...
    highlights: [
      ...
      { icon: 'rupee-sign', value: 'INR 20 Cr', label: 'Asset Value' },
  ...
  // ── 6. Maple Resort Chail, Himachal Pradesh ───────────────────────────────
  {
    ...
    highlights: [
      ...
      { icon: 'rupee-sign', value: 'INR 30 Cr', label: 'Asset Value' },
  ...
  // ── 7. Ambience Tower, Shalimar Bagh, North Delhi (JLL Listed) ────────────
  {
    ...
    highlights: [
      ...
      { icon: 'rupee-sign', value: 'INR 350 Cr', label: 'Asset Value' },
